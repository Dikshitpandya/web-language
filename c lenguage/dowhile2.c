...
void main()
{
    ...
    int number = 1, option,answer = 0,first =0, second =0 ,temp = 1;

    printf("select any option ");
    
    printf("enter 1 for square patten");
    printf("enter 2 for cube patten ");
    printf("enter 3 for lucas series ");
    printf("enter 4 for triangual number");
    scanf("%d",&option);
